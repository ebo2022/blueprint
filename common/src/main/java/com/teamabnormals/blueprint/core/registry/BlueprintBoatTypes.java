...
public final class BlueprintBoatTypes {
	 ...
	 */
	public static synchronized void registerType(ResourceLocation name, Supplier<? extends Item> boat, Supplier<? extends Item> chestBoat, Supplier<? extends Block> plank, boolean raft) {
	...
	public static void registerLayerDefinitions(EntityRendererEvents.RegisterLayerDefinitionsEvent.Context context) {
		...
		BOATS.forEach((name, type) -> {
			...
			context.registerLayerDefinition(type.getBoatModelLayerLocation(), isRaft ? () -> raftModel : () -> boatModel);
			context.registerLayerDefinition(type.getChestBoatModelLayerLocation(), isRaft ? () -> chestRaftModel : () -> chestBoatModel);
		});
	}
	...
	public static class BlueprintBoatType {
		...
		private final Supplier<? extends Block> plank;
		private final boolean raft;
		private final ResourceLocation texture;
		private final ResourceLocation chestVariantTexture;

		public BlueprintBoatType(ResourceLocation name, Supplier<? extends Item> boat, Supplier<? extends Item> chestBoat, Supplier<? extends Block> plank, boolean raft) {
			this.name = name;
			this.boat = boat;
