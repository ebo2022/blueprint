...
public class ItemStackBuilder {
	...
	public ItemStackBuilder addCanDestroy(Block block) {
		return this.addPredicate("CanDestroy", BuiltInRegistries.BLOCK.getKey(block).toString());
	}
	...
	public ItemStackBuilder addCanPlaceOn(Block block) {
		return this.addPredicate("CanPlaceOn", BuiltInRegistries.BLOCK.getKey(block).toString());
	}
